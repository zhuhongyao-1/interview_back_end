                          ...
                          >
                            <div class="testpaper-tab-1-frame-inside">
                              <div class="testpaper-tab-1-frame-inside-title">
                                ...
                                >
                                  <span @click="testtitle(testpapernew.title)"
                              ...
                              <div class="testpaper-tab-1-frame-inside-img">
                                ...
                                >
                                  <img
                                    :src="
                                      require(`../assets/img/${testpapernew.img_ico}`)
                                    "
                                    alt="百度"
                                  />
                                </div>
                              ...
                              >
                                <div
                                  class="testpaper-tab-1-frame-inside-describe-information"
                                >
                                  <button>
                                    {{ testpapernew.paper_tag_one }}
                                  </button>
                                  <button>
                                    {{ testpapernew.paper_tag_two }}
                                  </button>
                                  <button>
                                    {{ testpapernew.paper_tag_three }}
                                  </button>
                                </div>
                              </div>
                            </div>
...
export default {
  ...
  mounted() {
    ...
    console.log(this);
    this.$http({
      url: "http://localhost:3001/users/papersearchall",
      methods: "get",
    })
      .then((res) => {
    ...
    this.$http({
      url: "http://localhost:3001/users/papersearch",
      methods: "get",
    })
      .then((res) => {
    ...
    for (let i = 0; i <= tag.length - 1; i++) {
      tag[i].onclick = function () {
        ...
        that
          .$http({
            url: "http://localhost:3001/users/choose",
            methods: "get",
            params: {
  ...
  methods: {
    ...
    testpapervaluea() {
      (this.testpapervalue = false), console.log("1111111", this.testpaper);
      this.$http
        .post(
          //请求的url
